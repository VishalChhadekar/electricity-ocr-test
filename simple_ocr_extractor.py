...
class SimpleOCRExtractor:
    """Simple OCR extractor that focuses purely on text extraction."""
    ...
    def process_file(self, file_path: str) -> dict:
        ...
        try:
            ...
            self.logger.info(f"Successfully extracted {len(raw_text)} characters of text")
...
def main():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python simple_ocr_extractor.py --file "file samples/Maharastra.pdf" --lang mar
  python simple_ocr_extractor.py --file image.jpg --lang eng --output result.json
  python simple_ocr_extractor.py --file "file samples/Multiple-Meters.pdf" --lang eng --pretty
        """
    )
    ...
    try:
        # Initialize OCR tool
        ocr_tool = SimpleOCRExtractor(language=args.lang)
